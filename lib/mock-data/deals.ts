...
export const deals: Deal[] = [
  ...
  // Active in-progress deals for non-PBW events so the new-deal form
  // (which lets the user pick an event from /demo/discover) can route to
  // an event-appropriate settlement screen instead of always landing on
  // the Samsung × PBW page.
  {
    id: "dl_ultra_samsung",
    event_id: "evt_ultra_korea_2026",
    event_name: "Ultra Korea 2026",
    brand_id: "brnd_samsung",
    brand_name: "Samsung",
    tier: "Title",
    total_amount: 750_000,
    currency: "USDC",
    escrow_address: "rEScRoWuLtRaK0r3a2026XYZabcdef123456",
    status: "in_progress",
    contract_signed_at: "2026-04-22T09:00:00Z",
    event_starts_at: "2026-06-12T00:00:00Z",
    current_milestone_id: "ms_ultra_m3",
    xrpl_tx_hash:
      "A1B2C3D4E5F6789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456ULTRA",
    milestones: [
      { id: "ms_ultra_m1", label: "M1", trigger: "Booking confirmed · contract on-chain", amount: 150_000, percentage: 20, status: "released", released_at: "2026-04-23T11:00:00Z" },
      { id: "ms_ultra_m2", label: "M2", trigger: "Main stage build + headline DJ lineup confirmed", amount: 300_000, percentage: 40, status: "released", released_at: "2026-05-13T10:30:00Z" },
      { id: "ms_ultra_m3", label: "M3", trigger: "Day 1 doors open · attendance verified", amount: 225_000, percentage: 30, status: "pending" },
      { id: "ms_ultra_m4", label: "M4", trigger: "Post-event ROI report + audience data verified", amount: 75_000, percentage: 10, status: "locked" },
    ],
  },
  {
    id: "dl_soundstorm_samsung",
    event_id: "evt_soundstorm_2026",
    event_name: "Soundstorm 2026",
    brand_id: "brnd_samsung",
    brand_name: "Samsung",
    tier: "Title",
    total_amount: 1_500_000,
    currency: "USDC",
    escrow_address: "rEScRoWs0unDsT0rM2026MnRiyadhABCdef1",
    status: "in_progress",
    contract_signed_at: "2026-08-01T09:00:00Z",
    event_starts_at: "2026-12-01T00:00:00Z",
    current_milestone_id: "ms_ss_m2",
    xrpl_tx_hash:
      "B2C3D4E5F6789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456SOUND",
    milestones: [
      { id: "ms_ss_m1", label: "M1", trigger: "Booking confirmed · contract on-chain", amount: 300_000, percentage: 20, status: "released", released_at: "2026-08-02T11:00:00Z" },
      { id: "ms_ss_m2", label: "M2", trigger: "Main stage build + MDLBEAST headline confirmed", amount: 600_000, percentage: 40, status: "pending" },
      { id: "ms_ss_m3", label: "M3", trigger: "Day 1 doors open · attendance verified", amount: 450_000, percentage: 30, status: "locked" },
      { id: "ms_ss_m4", label: "M4", trigger: "Post-event ROI report + audience data verified", amount: 150_000, percentage: 10, status: "locked" },
    ],
  },
  {
    id: "dl_dubai_design_samsung",
    event_id: "evt_dubai_design_week_2026",
    event_name: "Dubai Design Week 2026",
    brand_id: "brnd_samsung",
    brand_name: "Samsung",
    tier: "Title",
    total_amount: 500_000,
    currency: "USDC",
    escrow_address: "rEScRoWdUbA1Des1gn2026Dxbabcdef9876",
    status: "in_progress",
    contract_signed_at: "2026-07-10T09:00:00Z",
    event_starts_at: "2026-11-04T00:00:00Z",
    current_milestone_id: "ms_ddw_m2",
    xrpl_tx_hash:
      "C3D4E5F6789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456DUBAI1",
    milestones: [
      { id: "ms_ddw_m1", label: "M1", trigger: "Booking confirmed · contract on-chain", amount: 100_000, percentage: 20, status: "released", released_at: "2026-07-11T11:00:00Z" },
      { id: "ms_ddw_m2", label: "M2", trigger: "Pavilion build + editorial integration confirmed", amount: 200_000, percentage: 40, status: "pending" },
      { id: "ms_ddw_m3", label: "M3", trigger: "Opening day · attendance verified", amount: 150_000, percentage: 30, status: "locked" },
      { id: "ms_ddw_m4", label: "M4", trigger: "Post-event ROI report + audience data verified", amount: 50_000, percentage: 10, status: "locked" },
    ],
  },
  {
